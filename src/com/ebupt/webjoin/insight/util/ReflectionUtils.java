 ...
 * 
 * Borrowed from org.springframework.util.ReflectionUtils.  Asserts removed 
...
//        Assert.isTrue(name != null || type != null, "Either name or type of the field must be specified");
    ...
    public static Method findMethod(Class<?> clazz, String name) {
        return findMethod(clazz, name, ArrayUtil.EMPTY_CLASSES);
    }
    ...
    /**
     * Invokes the specified <U>static</U> {@link Method}
     * @param method
     * @return
     */
    public static Object invokeStaticMethod(Method method) {
    	...
    	if (!Modifier.isStatic(mod)) {
    		throw new IllegalArgumentException("invokeStaticMethod(" + method + ") not static");
    	}
    ...
    public static Object invokeMethod(Method method, Object target) {
        return invokeMethod(method, target, ArrayUtil.EMPTY_OBJECTS);
    }
